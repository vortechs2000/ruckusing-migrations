...
if ($php53) {
    $files = array(
            __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR . 'flight' . DIRECTORY_SEPARATOR . 'autoload.php',
    );
...
define('RUCKUSING_WORKING_BASE', dirname($_SERVER['SCRIPT_FILENAME']));
